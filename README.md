...
**`QA Analyst | Automação de Testes | Implantação de Software | Dados (SQL/XML)`**

Sou QA Analyst com foco em automação de testes para aplicações web.
Atuo com desenvolvimento e manutenção de testes automatizados em Python,
integração com pipelines CI/CD (Jenkins) 
Conversão e validação de dados via SQL/XML.
